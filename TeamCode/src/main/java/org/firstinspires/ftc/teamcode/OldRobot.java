...
public class OldRobot {
        ...
        public OldRobot(HardwareMap hardwareMap, Telemetry telemetry, Gamepad gamepad1, Gamepad gamepad2, boolean _redAlliance) {
        ...
        public void setTriggerCycleNumber (int set) {
            triggerCycleNumber = set;
        }
